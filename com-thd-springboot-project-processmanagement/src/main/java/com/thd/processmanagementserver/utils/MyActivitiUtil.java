...
//	/**
//	 * Method Description : 删除流程定义
//	 *
//	 * @param processDefId 流程定义ID
//	 * @return
//	 */
//	public void deleteProcessDef(String processDefId) {
//		log.info("================ deleteProcessDef [" + processDefId + "] Start ===================");
//		//删除流程实例
//		List<ProcessInstance> proInsList =  runtimeService.createProcessInstanceQuery().processDefinitionId(processDefId).list();
//		if(proInsList!=null && proInsList.size()>=0){
//			for(ProcessInstance pi : proInsList){
//				this.runtimeService.deleteProcessInstance(pi.getProcessInstanceId(), "process defined be deleted");
//			}
//		}
//		//删除流程实例历史
//		List<HistoricProcessInstance> hisList = this.historyService.createHistoricProcessInstanceQuery().processDefinitionId(processDefId).list();
//		if(hisList!=null && hisList.size()>=0){
//			for(HistoricProcessInstance hi : hisList){
//				this.historyService.deleteHistoricProcessInstance(hi.getId());
//			}
...
//
//		//删除流程部署
//		this.getProcessEngine().getRepositoryService().delete
//		log.info("================ deleteProcessDef [" + processDefId + "] End ===================");
//	}
